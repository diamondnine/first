<?php
	echo '<div style="margin-top:15px;margin-left:485px;font-size:30px;">中央处理器超标记录</div>';
	$con= mysqli_connect('localhost','root','','server_online_monitoring_system');
	$sqls = "select * from server_warning_table where warning_choice = 'cpu' order by warning_time desc ";
