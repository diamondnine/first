<?php
	echo '<div style="margin-top:15px;margin-left:495px;font-size:30px;">外存储器超标记录</div>';
	$con= mysqli_connect('localhost','root','','server_online_monitoring_system');
	$sqls = "select * from server_warning_table where warning_choice = 'hardpan' order by warning_time desc ";
