...
QT_MOC_LITERAL(1, 9, 9), // "lginforms"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 3), // "obj"
QT_MOC_LITERAL(4, 24, 9), // "lgclearme"
QT_MOC_LITERAL(5, 34, 10) // "lginformss"

    },
    "DlgLogin\0lginforms\0\0obj\0lgclearme\0"
    "lginformss"
};
...
void DlgLogin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->lginforms((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->lgclearme(); break;
        case 2: _t->lginformss(); break;
        default: ;
        }
        ...
        {
            typedef void (DlgLogin::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DlgLogin::lginforms)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject DlgLogin::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DlgLogin.data,
      qt_meta_data_DlgLogin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void DlgLogin::lginforms(QString _t1)
{
